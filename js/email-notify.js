...
export async function sendMarkingEmail({ name, day, score, maxScore, scoreByDay, flagsCount }) {
  try {
    ...
    const subject = `SQL Account — ${displayName}: Day ${day} Result`;
    ...
    const html = `
      <div style="font-family:Arial,Helvetica,sans-serif;max-width:480px;margin:0 auto;">
        <div style="background:#1f4e79;color:#fff;padding:16px 20px;border-radius:8px 8px 0 0;">
          <div style="font-size:12px;letter-spacing:0.5px;opacity:0.8;text-transform:uppercase;">SQL Account &middot; Onboarding</div>
